...
public class GuiAchievements extends GuiScreen implements IProgressMeter
{
    ...
    protected void func_146552_b(int p_146552_1_, int p_146552_2_, float p_146552_3_)
    {
        ...
        if (achievement != null)
        {
            String s2 = achievement.func_150951_e().getUnformattedText();
            ...
            if (!this.field_146556_E.canUnlockAchievement(achievement))
            {
                ...
                if (i4 == 3)
                {
                    ...
                    j4 = Math.max(this.fontRendererObj.getStringWidth(s2), 120);
                    ...
                    this.fontRendererObj.drawSplitString(s, l4, i5 + 12, j4, -9416624);
                }
                else if (i4 < 3)
                {
                    j4 = Math.max(this.fontRendererObj.getStringWidth(s2), 120);
            ...
            {
                j4 = Math.max(this.fontRendererObj.getStringWidth(s2), 120);
                int k5 = this.fontRendererObj.splitStringWidth(s1, j4);
                ...
                this.fontRendererObj.drawSplitString(s1, l4, i5 + 12, j4, -6250336);

                if (this.field_146556_E.hasAchievementUnlocked(achievement))
                {
                    this.fontRendererObj.drawStringWithShadow(I18n.format("achievement.taken", new Object[0]), l4, i5 + k5 + 4, -7302913);
                }
            }

            if (s2 != null)
            {
                this.fontRendererObj.drawStringWithShadow(s2, l4, i5, this.field_146556_E.canUnlockAchievement(achievement) ? (achievement.getSpecial() ? -128 : -1) : (achievement.getSpecial() ? -8355776 : -8355712));
            }
        }
